$(document).ready(function($) {
	...
	$( "#showTeam_trigger" ).click(function() {
  		
  		if ($( "#section-more-team" ).is( ":hidden" )){
  			$("#section-more-team").toggle();
  			$([document.documentElement, document.body]).animate({
        		scrollTop: $("#section-more-team").offset().top
    		}, 700);
    		$('#showTeam_trigger').text('Hide The Team');
  		}else{
  			$("#section-more-team").toggle();
  			$([document.documentElement, document.body]).animate({
        		scrollTop: $("#section-team").offset().top
    		}, 700);
    		$('#showTeam_trigger').text('See The Whole Team');
  		}
	});

	$( "#hideTeam_trigger" ).click(function() {
  		
  		if ($( "#section-more-team" ).is( ":visible" )){
  			$('#showTeam_trigger').text('See The Whole Team');
  			$([document.documentElement, document.body]).animate({
        		scrollTop: $("#section-team").offset().top
    		}, 700, function() {
